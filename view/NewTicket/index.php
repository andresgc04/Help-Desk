				...
				<div class="row">
					...
					<div class="col-lg-6">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Ingrese El Titulo Del Ticket">
						</fieldset>
					</div>
					<div class="col-lg-12">
						<fieldset class="form-group">
							...
							<div class="summernote-theme-1">
								<textarea id="ticket_Descripcion" class="summernote" name="name"></textarea>
							</div>
						</fieldset>
					</div>
					<div class="col-lg-12">
